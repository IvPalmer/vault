...
export const BABY_IMPLICATIONS = [
  ...
  },
  {
    ...
    acoes: [
      ...
      '⚠️ Discutir vacina hep B na 2ª consulta (Anti-HBs <2,0 mUI/mL)',
      '⚠️ Repetir sorologia toxoplasmose a cada trimestre (~ago/2026 e ~nov/2026) — Rafa suscetível',
...

  {
    ...
    titulo: '⚠️ Hepatite B — Rafa sem proteção vacinal (Anti-HBs <2,0)',
...

  {
    ...
    titulo: '⚠️ Toxoplasmose — Rafa suscetível (IgG negativa)',
    origem: 'Rafa · painel 1º T 2026-05-06 (DASA, Dra. Nahara)',
    categoria: 'Risco infeccioso',
    prioridade: 'alta',
    marker_refs: [
