...
export const BABY_IMPLICATIONS = [
  ...
  {
    id: 'orcamento-parto',
    titulo: 'Orçamento parto particular — R$ 32-39k esperado · R$ 50-70k com margem UTI',
    origem: 'family/finance/projecao_parto.md · pesquisa de mercado 05/05/2026',
    categoria: 'Financeiro',
    prioridade: 'alta',
    resumo: 'Como Amil não cobre obstetrícia (carência 300d > parto), o parto será 100% particular. Soma das peças: consultas pré-natais (R$7k) + honorários Dra. Nahara (R$10k) + hospital (R$15-22k) = ~R$32-39k esperado. UTI neonatal é o swing factor (5-10% prob, R$5-10k/dia) — 5 dias adiciona ~R$37k.',
    acoes: [
      'Consultas pré-natais: 14 × R$500 = R$ 7.000 total (calendário: 5 mensais → 4 quinzenais 28-36s → 4 semanais 36s-parto)',
      'Honorários Dra. Nahara para parto: R$ 10.000 (informado pela médica)',
      'Hospital mid-high (Maternidade Brasília / Santa Luzia / Anchieta): R$ 15-22k pacote — confirmar quais a Dra. Nahara opera',
      'Reserva mínima R$ 35-40k em conta liquidez diária (Tesouro Selic / CDB liq. diária)',
      'Reserva IDEAL R$ 50-70k (margem UTI neonatal 3-5 dias)',
      'Alternativa estratégica: manter Nova Saúde paralelo ~R$ 2-3k/mês × 8 meses = R$ 16-24k — financeiramente equivale ao particular E mitiga risco UTI (R$ 50-100k). Cotar.',
      'Construir reserva até dez/2026 (~8 meses) — incrementar ~R$ 6-9k/mês a partir de jun/2026',
    ],
  },
  {
