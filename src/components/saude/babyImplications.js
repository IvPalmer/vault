...
export const BABY_IMPLICATIONS = [
  ...
  {
    id: 'cobertura-amil',
    titulo: 'Carência obstétrica Amil 300 dias — IRREDUCÍVEL',
    origem: 'Áudio corretor Luiz Carvalho 04/05/2026 + tabela ANS PRC 609',
    categoria: 'Cobertura assistencial',
    prioridade: 'alta',
    resumo: 'Encerrado pelo corretor: 300 dias obstetrícia/neonatologia é INTRANSPONÍVEL no PRC 609 (e em todas as colunas — 606/607/608/609/617). Operadora não permite compra de carência. Esclarecimento: Nova Saúde NÃO é congênere da Amil (congêneres = Sul América, Unimed, Bradesco). Plano: Amil 702 PME Bronze DF, vigência ~28/04/2026. Fim carência obstétrica ~21/02/2027. DPP estimada ~02/01/2027 → parto ~50 dias antes do fim. Plano B é mandatório.',
    acoes: [
  ...
  {
    id: 'proposta-proasa-easyplan-2026-05-05',
    titulo: 'Proposta Easyplan / Proasa — Palmer ADV 400 + Rafa ADV 300 (DEADLINE 05/05)',
    origem: 'Email Easyplan 05/05/2026 · family/finance/proposta_proasa_easyplan.md',
    categoria: 'Cobertura assistencial',
    prioridade: 'alta',
    resumo: '2 emails separados: Palmer titular ADV 400 DF (apartamento, R$ 502,63/mês) e Rafa titular ADV 300 DF (ENFERMARIA, R$ 503,67/mês). Estratégico: Rafa pode aderir SOZINHA, Palmer continua Amil. CRÍTICO: ADV 300 standard libera parto em 04/03/2027 (60d depois da DPP) — só vale aderir SE aproveitamento de carência por escrito. SEM aproveitamento, é 12 dias PIOR que ficar só Amil. Para apartamento no parto, ADV 300 cobra upgrade ~R$ 500-1.500/dia. Negociar Easyplan migrar Rafa para ADV 400 (mesmo preço, apto incluído).',
    acoes: [
      'NÃO responder "Estou de acordo" antes de validar 9 pontos por escrito (PDF)',
      'NEGOCIAR: pedir Easyplan migrar oferta Rafa para ADV 400 DF (apto incluído pelo mesmo preço ~R$ 503)',
      'EXIGIR: documento explícito que carência obstétrica está zerada (RN 438/2018 ou contrato direto). SEM esse doc → não aderir',
      'Confirmar: coparticipação % real (email diz "sem", padrão Proasa é coparticipativo — pegadinha provável)',
      'Sem aproveitamento de carência, Proasa libera parto em 04/03/2027 vs Amil 21/02/2027 → Proasa fica PIOR que status quo',
      'Cenário 5b real (ADV 300 DF Rafa): R$ 6-10k em 8 meses (mensalidade R$ 4k + copay + upgrade apto parto) → próximo de Nova Saúde R$ 6.4k',
      'Strategic: Palmer continua Amil R$ 900, Rafa adere Proasa R$ 503 = R$ 1.403/mês (R$ 297 abaixo de Amil + Nova Saúde Rafa)',
      'Ligar (61) 4003-7172 ou WhatsApp (61) 3142-1077 amanhã 8h — pedir 24h prazo + contrato PDF',
      'Detalhes + 9 perguntas obrigatórias em family/finance/proposta_proasa_easyplan.md',
    ],
  },
  {
    id: 'orcamento-parto',
    titulo: 'Cenário ÓTIMO: reativar Nova Saúde Rafa paralelo · economia R$ 25.6-63k',
    origem: 'family/finance/projecao_parto.md · valores reais informados 05/05/2026',
    categoria: 'Financeiro',
    prioridade: 'alta',
    resumo: 'Custos reais: Nova Saúde anterior R$ 800 Rafa + R$ 1.200 Palmer = R$ 2.000/mês. Amil atual R$ 900/mês ambos. Cenário 2 (Amil + Nova Saúde Rafa paralelo 8 meses): R$ 13.600 total · cobre parto + UTI. Cenário 1 (só Amil + parto particular): R$ 39.200 esperado · R$ 76.700 se UTI. Diferença de R$ 25.600 (esperado) a R$ 63.100 (com UTI). VALIDAR URGENTE com Nova Saúde se aceita continuidade da Rafa sem reset de carência.',
    acoes: [
      'URGENTE — Ligar Nova Saúde HOJE: (1) plano Rafa cancelado ou suspenso? (2) reativar individual aproveita carência >12mo? (3) portabilidade obstétrica RN 438/2018? (4) valor atual Rafa individual? (5) documento por escrito',
      'Se Nova Saúde aceita: Cenário 2 → R$ 1.700/mês durante gestação (Amil 900 + NS Rafa 800), parto/UTI cobertos. Total 8 meses R$ 13.600.',
      'Se Nova Saúde NÃO aceita: Cenário 1 → reserva mínima R$ 35-40k (parto particular esperado R$ 32-39k) ou R$ 50-70k com margem UTI',
      'Cenário 2 ainda fica R$ 300/mês ABAIXO do que pagavam só Nova Saúde antes (R$ 1.700 vs R$ 2.000)',
      'Custo plano Amil só: R$ 900 × 8 = R$ 7.200 já vai entrar nos próximos 8 meses qualquer cenário',
      'Honorários Dra. Nahara: R$ 500/consulta × ~14 = R$ 7.000 + R$ 10.000 parto = R$ 17.000 (se Cenário 1)',
      'Hospital Brasília (Cenário 1): Maternidade Brasília R$ 12-18k, Santa Luzia R$ 18-22k, DF Star R$ 19-25k',
      'Detalhes em family/finance/projecao_parto.md',
    ],
  },
  {
