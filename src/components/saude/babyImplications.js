...
export const BABY_IMPLICATIONS = [
  ...
  },
  {
    ...
    titulo: 'Proposta Easyplan / Proasa ADV 400 DF — DEADLINE HOJE 05/05/2026',
    origem: 'Email Easyplan 05/05/2026 10:20 BRT · family/finance/proposta_proasa_easyplan.md',
    categoria: 'Cobertura assistencial',
    prioridade: 'alta',
    resumo: 'Email da Easyplan (administradora) oferece adesão ao plano Proasa Saúde ADV 400 DF com vigência 10/05 e pagamento até 05/05. Pontos atrativos: aproveitamento de carências, "sem coparticipação", rede inclui Maternidade Brasília. Validações OBRIGATÓRIAS por escrito antes de aderir — email diz "sem coparticipação" mas plano padrão Proasa É coparticipativo. Faixa 30-38 anos: R$ 502-700/mês estimado. Se carência aproveitada confirmada → potencialmente R$ 1-2k mais barato que Nova Saúde paralelo, com cobertura igualmente boa.',
    acoes: [
      'NÃO responder "Estou de acordo com a oferta" antes de validar 8 pontos por escrito',
      'Ligar (61) 4003-7172 ou WhatsApp (61) 3142-1077 — pedir contrato em PDF',
      'Validar: preço exato Palmer + Rafa, coparticipação %, aproveitamento carência obstétrica POR ESCRITO, plano Empresarial ou Adesão',
      'Se Easyplan recusar contrato escrito ou exigir adesão imediata sem doc → NÃO ADERIR (golpe ou pegadinha)',
      'Pedir 24h prazo — se recusar, é alerta vermelho',
      'Comparar em paralelo com Nova Saúde (cotar reativação Rafa)',
      'Operadora Proasa É real (ANS, 36k beneficiários, 30 anos) — risco principal é cláusulas do contrato específico',
      'Detalhes + 8 perguntas obrigatórias em family/finance/proposta_proasa_easyplan.md',
    ],
  },
  {
    id: 'orcamento-parto',
