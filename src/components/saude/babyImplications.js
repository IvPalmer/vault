...
export const BABY_IMPLICATIONS = [
  ...
  },
  {
    ...
    acoes: [
      ...
      'Honorários Dra. Nahara: R$ 500/consulta × ~13 = R$ 6.500 + R$ 10.000 parto = R$ 16.500 (out-of-pocket sempre, fora rede Proasa)',
  ...
  },
  {
    ...
    titulo: '1ª consulta realizada — labs coletados 06/05 · USG agendada 18/05',
    origem: 'Dra. Nahara A. G. Torres (CRM-DF 18529, Grupo Elas) · 05/05/2026',
    categoria: 'Pré-natal · 1º trimestre',
    prioridade: 'alta',
    resumo: 'Painel laboratorial 1º tri completo (14 exames) + USG transvaginal gestacional. Receituário: Ogestan-Pré 1×/dia + sintomáticos conforme necessidade. Status 06/05: 13 labs coletados em jejum 12h, vit D aguardando autorização, USG agendada 18/05.',
    acoes: [
      '✅ 13 labs coletados em 06/05/2026 (jejum 12h cumprido) — aguardando resultados ~3-7 dias úteis',
      '⏳ Vitamina D aguardando autorização do plano (Amil ou Proasa cobrem como exame básico)',
      '📅 USG transvaginal agendada para 18/05/2026 (~IG 7+4) — coberta pela Proasa desde adesão 06/05; Amil libera só em 28/05',
      'Próxima consulta Dra. Nahara: ~05/06/2026 (1 mês após 1ª)',
      '✅ Ogestan-Pré em uso desde 05/05',
      'Quando resultados saírem: enviar PDFs para parsing + atualização dos LabMarker do banco',
    ],
  },
