...
export const BABY_IMPLICATIONS = [
...

  {
    ...
    acoes: [
      ...
      'Mapear maternidades particulares Brasília + valores parto/cesariana',
      'Confirmar com obstetra escolhido se atende em rede particular fora Amil',
      'Lei 9656/98 cobre apenas emergência obstétrica 24h pós-vigência (intercorrências graves, não parto eletivo)',
      'Documentar tudo: histórico de pagamento + e-mail formal pedindo análise excepcional (mesmo com baixa chance)',
    ],
  },
  {
    ...
    acoes: [
      'Consultas pré-natal: 1 dia de carência (já liberadas)',
      'Exames laboratoriais básicos: 1 dia (já liberados)',
      'USG (datação, morfológica, obstétrica): 30 dias → liberadas desde ~28/05/2026',
      'TC/RM/cardio (caso necessário): 30 dias → já liberados',
      'Internação clínica não-obstétrica: 60 dias → liberada desde ~27/06/2026',
      'Cirurgia day-hospital não-obstétrica: 60 dias → já liberada',
      'Psicoterapia (suporte gestacional/pós-parto): 180 dias → liberada ~25/10/2026',
      'Nutrição: 180 dias → liberada ~25/10/2026',
    ],
  },
